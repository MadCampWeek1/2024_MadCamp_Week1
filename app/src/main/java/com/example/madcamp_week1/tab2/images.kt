...
class HomeFragment : Fragment() {
    ...
    private val theme1Images = listOf(R.drawable.dog1, R.drawable.dog2, R.drawable.cat1, R.drawable.cat2, R.drawable.cat3, R.drawable.fish1, R.drawable.fish2, R.drawable.dog1, R.drawable.dog2, R.drawable.cat1, R.drawable.cat2, R.drawable.cat3, R.drawable.fish1, R.drawable.fish2, R.drawable.dog1, R.drawable.dog2, R.drawable.cat1, R.drawable.cat2, R.drawable.cat3)
